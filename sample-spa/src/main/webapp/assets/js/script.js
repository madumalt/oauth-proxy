	...
	function render(url) {
		...
		var	map = {
            ...
            '': function() {
                ...
                // Keep everything as it is and go to the login page.
                renderLoginPage();
            },

			// Once logout, show the Login Page.
            '#logout': function() {

            	// TODO clear the cookie send logout request to the oauth-proxy.

                // Clear the filters object, uncheck all checkboxes, go to login page.
                filters = {};
			...
			'#home': function() {
                ...
                // TODO check validity of the access token against the oauth-proxy.
		...
		// If the keyword isn't listed in the above - render the login/home page.
		else {
			// TODO check the validity of the access-token against the oauth-proxy,
			// TODO if valid render home-page, else render login-page.
			renderLoginPage();
		}
